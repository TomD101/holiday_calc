...
# Input questions
city_flight = input ("Where do you want to fly to? Your choices are London, Barcelona, Milan, Prague or Copenhahen : ")
...
print(f"£{hotel_cost(num_nights)} for the hotel,")
print(f"and £{(car_rental(rental_days))} for the car rental.")
